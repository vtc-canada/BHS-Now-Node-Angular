...
//.controller('ContactSections', function($scope, $rootScope, $timeout, $filter, $state, $modal, $contact, $sails, Utility) {
...
.controller('SecurityGroups', function($scope, $rootScope, $timeout, $sails, $modal, DTOptionsBuilder, DTColumnBuilder) {
	...
	if(resource.id==null){
	    console.log('wasnull');//delete resource;  
	}
//	$timeout(function(){
//		$scope.group.resources.push({id:null,createdAt : new Date(), updatedAt : new Date(), name : null, create:0,read:0,update:0,delete:0});
//	},0);
    }
...
//.controller(
//    'DpCodesDatatable',
//    function($scope, $rootScope, $timeout, DTOptionsBuilder, DTColumnBuilder, $sails, $modal) {
//
//	var vm = this;
//	$scope.selectedCode = null;
//	$scope.dpcodes = [];
